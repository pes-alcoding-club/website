...
const AboutContest: React.FC<AboutContestProps> = () => (
    <Box w="100%" p="5">
        <Heading
            fontSize="4xl"
            textAlign="center"
        ...
        <Box w={{ xl: '45%', lg: '60%', base: '95%' }} mx="auto">
            ...
            <Text fontSize={{ lg: 'xl', base: 'lg' }} my="5" lineHeight="32px">
                ...
                contest of competitive coding from 7:30PM to 10:30PM on
                September 11th, and emerge victorious.
            </Text>
            <Text fontSize={{ lg: 'xl', base: 'lg' }} my="5" lineHeight="32px">
                This is a chance for you to find out what competitive coding is
                all about, and maybe put yourselves on our radar!
            </Text>
            <Text fontSize={{ lg: 'xl', base: 'lg' }} my="5" lineHeight="32px">
                The contest is open to anyone who wants to participate, so go
                ahead and register.
            </Text>
        </Box>
    </Box>
